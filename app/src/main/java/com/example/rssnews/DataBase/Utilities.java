...
public class Utilities {
    ...
    public static final String ROOT_DIR_STORAGE_PICTURE_CACHE = "/data/data/com.example.rssnews/cache/picture_cache";

    //    Chỗ lưu nội dung tin tức khi lưu đọc offline
    @SuppressLint("SdCardPath")
    public static final String ROOT_DIR_STORAGE_HTML_CACHE = "/data/data/com.example.rssnews/cache/html_cache";;
